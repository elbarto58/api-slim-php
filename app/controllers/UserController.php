...
/**
	* Controlador que crea, lee, actualiza y elimina registros de una tabla en MySQL con las peticiones GET, POST, PUT y DELETE.
*/
class UserController {
	...
	*/
	public function UpdateUser(Req $req, Res $res, array $args){
		$message = '';//opcional - inicializar message en vacio
		$status = true;//estado inicial de nuestro status
		$id = $args['id'];//cachamos el id del usuario a actualizar
		$data_user = UserModel::find($args['id']);//buscamos al usuario mediante el id
	...
	*/
	public function DeleteUser(Req $req, Res $res, array $args){
		$message = '';//opcional - inicializar message en vacio
		$status = true;//estado inicial de nuestro status
		$id = $args['id'];//cachamos el id del usuario a eliminar
		$data_user = UserModel::find($args['id']);//buscamos al usuario mediante el id
		if($data_user){//si encontro algún dato relacionado
